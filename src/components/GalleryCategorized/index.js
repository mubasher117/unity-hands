...
class GalleryCategorized extends Component {
  state = {
    Child: false,
    Charity: false,
    Volunteering: false,
          ...
          <div className="row">
            <div className="col col-xs-12 sortable-gallery">
              ...
              <div className="gallery-container gallery-fancybox masonry-gallery payra-masonary">
                ...
                >
                  <ReactFancyBox thumbnail={Gallery_1} image={Gallery_1} />
                  <div className="icon">
                    <Link
                ...
                <div
                  className={
                    this.state.Child
                      ? "grid active"
                      : "grid" && this.state.Charity
                      ? "grid active"
                      : "grid" && this.state.Volunteering
                      ? "grid active"
                      : "grid" && this.state.Sponsorship
                      ? "grid active"
                      : "grid" && this.state.isOpen
                      ? "grid"
                      : "grid open"
